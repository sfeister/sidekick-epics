...
drvAsynSerialPortConfigure("photo2_ino","/dev/ttyUSB1")
asynSetOption("photo2_ino",0,"baud","9600")
asynSetOption("photo2_ino",0,"bits","8")
asynSetOption("photo2_ino",0,"parity","none")
asynSetOption("photo2_ino",0,"stop","1")
asynSetOption("photo2_ino",0,"clocal","Y")
asynSetOption("photo2_ino",0,"crtscts","N")
